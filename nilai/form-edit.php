              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample" action="proses-edit.php" enctype="multipart/form-data" method="post">
                    <input name="id_nilai" type="hidden" value="<?php echo $id_nilai; ?>"/>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">NAMA</label>
                          <div class="col-sm-9">
                            <input name="nim_nilai" type="text" class="form-control" value="<?php echo $row['nim_nilai']; ?>" readonly=""/>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="kode_matkul_nilai" type="text" class="form-control" value="<?php echo $row['kode_matkul_nilai']; ?>" readonly=""/>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            ...
                            <?php
                            //  echo "<option value='$row[uts]' selected>$row[uts]</option>";
                            //  for($nilai=0; $nilai<count($daftarnilai); $nilai++){
                            //    if($row["uts"] != $daftarnilai[$nilai])
                            //    {
                            ...
                            //?>
                            <!--</select>-->
                            <input type="text" name="uts" class="form-control" value="<?php echo $row['uts']; ?>"/>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            ...
                            <?php
                            //  echo "<option value='$row[uas]' selected>$row[uas]</option>";
                            //  for($nilai=0; $nilai<count($daftarnilai); $nilai++){
                            //    if($row["uas"] != $daftarnilai[$nilai])
                            //    {
                            //      echo "<option value='$daftarnilai[$nilai]'>$daftarnilai[$nilai]</option>";
                            //    }
                            //    
                            ...
                            //?>
                            <!--</select>-->
                            <input type="text" name="uas" class="form-control" value="<?php echo $row['uas']; ?>"/>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            ...
                            <?php
                            //  echo "<option value='$row[tugas]' selected>$row[tugas]</option>";
                            //  for($nilai=0; $nilai<count($daftarnilai); $nilai++){
                            //    if($row["tugas"] != $daftarnilai[$nilai])
                            //    {
                            //      echo "<option value='$daftarnilai[$nilai]'>$daftarnilai[$nilai]</option>";
                            //    }
                            //    
