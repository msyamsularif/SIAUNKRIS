    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 style="font-size: 20px" class="card-title">Data Ruangan</h4>
            ...
            <tr>
                ...
                <tbody>';
                      ...
                      while ($row = mysqli_fetch_array($query)) {
                        ...
                        echo "<td align='center'><a href='form-edit.php?kode_ruangan=$row[kode_ruangan]'>Edit</a> | <a href='delete.php?kode_ruangan=$row[kode_ruangan]'>Delete</a></td></tr>";     
                      }
                      echo '
              </tbody>
              <tfoot>
