    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            ...
            <div class="card-body">
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item active" href="index.php">Teknik Informatika</a>
          ...
          <?php
          $sql = 'SELECT nim, nama, email, no_telp, prodi, shift, status FROM data_mahasiswa WHERE prodi = "informatika"';
